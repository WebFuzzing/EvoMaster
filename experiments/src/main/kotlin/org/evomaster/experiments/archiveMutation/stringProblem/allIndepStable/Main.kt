    ...
    companion object{
        ...
        private fun run(args: Array<String>, nTargets : Int = 1, specifiedLength : Int = 16, maxLength: Int = 16) : Solution<StringIndividual>{
            ...
            val injector: Injector = LifecycleInjector.builder()
                    .withModules(* arrayOf<Module>(IndepStableStringModule(), StringModule(), BaseModule(args)))
                    .build().createInjector()

            val spd : IndepStableStringProblemDefinition = injector.getInstance(IndepStableStringProblemDefinition::class.java)
        ...
        private fun getArgs(budget: Int = 1000, probOfArchiveMutation : Double = 1.0, method : ImpactMutationSelection = ImpactMutationSelection.FEED_BACK, problem: String, writeStatistics : Boolean = true) = arrayOf(
                "--stoppingCriterion",
                "FITNESS_EVALUATIONS",
