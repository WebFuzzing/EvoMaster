...
public interface AdditionalTargetCollector {
     ...
     */
    void reportActionIndex(int actionIndex);
     ...
     */
    List<TargetInfo> testFinishedCollectResult();
}
