...
class EMConfig {
    ...
    companion object {
         ...
         *
         * Chosen from measurements: one system under test issued 2,153 distinct queries in a
         * one-hour search, and with the previous bound of 500 nearly half of its cache misses were
         * re-solves of entries that had been evicted rather than genuinely new queries. Entries are
         * small — a query string and a solver result — so a higher bound costs little memory and
         * removes that whole class of wasted work.
         */
