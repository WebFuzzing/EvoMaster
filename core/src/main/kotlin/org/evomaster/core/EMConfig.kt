...
import org.evomaster.core.utils.CliUtils
...
class EMConfig {
    ...
    fun updateProperties(options: OptionSet) {
        ...
        CliUtils.updateProperty(options, configPath)
        ...
        properties.forEach { m ->
            ...
            CliUtils.updateProperty(options, m)
        ...
        val modifiedOptions = CliUtils.modifiedOptions(options, cff)
