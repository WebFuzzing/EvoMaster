...
class TestSuiteWriter {
    ...
    companion object {
        ...
        private fun classDescriptionComment(solution: Solution<*>, format: OutputFormat, lines: Lines, stc: SearchTimeController) {
            lines.add("/**")
        ...
        private fun header(solution: Solution<*>,
            ...
            classDescriptionComment(solution, format, lines, stc)
