...
interface DeriveResourceBinding {
    ...
    fun deriveResourceToTable(resourceCluster: MutableList<RestResourceNode>, allTables : Map<TableId, Table>)
    /**
     * derive relationship between a resource and a table
     */
    fun deriveResourceToTable(resourceNode : RestResourceNode, allTables : Map<TableId, Table>)
