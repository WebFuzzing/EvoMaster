...
interface DeriveResourceBinding {
    ...
    fun generateRelatedTables(paramsInfo: List<ParamInfo>, calls: RestResourceCalls, dbActions : MutableList<DbAction>) :  MutableMap<RestAction, MutableList<ParamGeneBindMap>>? = null
