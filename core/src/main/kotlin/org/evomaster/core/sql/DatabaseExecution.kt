...
import org.evomaster.client.java.controller.api.dto.database.SqlExecutionLogDto
...
class DatabaseExecution(
    ...
    companion object {
        ...
        fun fromDto(dto: org.evomaster.client.java.controller.api.dto.database.ExecutionDto?): DatabaseExecution {
        ...
        private fun cloneSqlExecutionInfo(data: List<org.evomaster.client.java.controller.api.dto.database.SqlExecutionLogDto>?): List<SqlExecutionInfo> {
            if (data == null) {
                return listOf()
            }
