...
/**
 * If for any reason we need to provide external links for documentation (e.g., in log messages),
 * let's have them concentrated here in this file, so they can be easily reviewed and updated
 * in case of changes.
 */
