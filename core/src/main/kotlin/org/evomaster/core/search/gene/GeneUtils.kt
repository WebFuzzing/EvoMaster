...
object GeneUtils {
    ...
    enum class EscapeMode {
        ...
        BOOLEAN_SELECTION_UNION_OBJECT_MODE,
        BOOLEAN_SELECTION_UNION_OBJECT_FIELDS_MODE,
        GQL_STR_VALUE
    }
    ...
    fun applyEscapes(string: String, mode: EscapeMode = EscapeMode.NONE, format: OutputFormat): String {
        val ret = when (mode) {
            ...
            EscapeMode.BOOLEAN_SELECTION_UNION_OBJECT_MODE,
            EscapeMode.BOOLEAN_SELECTION_UNION_OBJECT_FIELDS_MODE,
