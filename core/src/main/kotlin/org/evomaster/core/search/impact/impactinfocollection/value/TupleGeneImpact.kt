    ...
    override fun countImpactWithMutatedGeneWithContext(gc: MutatedGeneWithContext, noImpactTargets: Set<Int>, impactTargets: Set<Int>, improvedTargets: Set<Int>, onlyManipulation: Boolean) {
        ...
        if (gc.previous == null){
            gc.current.elements.forEach { gene ->
                ...
                val mutatedGeneWithContext = MutatedGeneWithContext(previous = null, current =  gene, action = "none", actionLocalId = gc.actionLocalId, numOfMutatedGene = gc.current.elements.size)
        ...
        mutatedElements.forEach { g->
            ...
            val mutatedGeneWithContext = MutatedGeneWithContext(previous = g.second, current =  g.first, action = "none", actionLocalId = gc.actionLocalId, numOfMutatedGene = gc.numOfMutatedGene * mutatedElements.size)
            fImpact.countImpactWithMutatedGeneWithContext(mutatedGeneWithContext, noImpactTargets = noImpactTargets, impactTargets = impactTargets, improvedTargets = improvedTargets, onlyManipulation = onlyManipulation)
        }
    }
