 ...
 * But we need to have way to create unique ids without a dependency injection.
 * As this should have extremely low impact on the execution, forgetting to reset
 * it at each test case should have no impact, apart from very, very special cases (eg,
