...
fragment ClassRanges
 :  //[empty]
 | NonemptyClassRanges
 ;


fragment NonemptyClassRanges
 : ClassAtom
 | ClassAtom NonemptyClassRangesNoDash
 | ClassAtom '-' ClassAtom ClassRanges
 ;

fragment NonemptyClassRangesNoDash
 : ClassAtom
...
// Maybe we just need Pattern, and not analyze the literals
