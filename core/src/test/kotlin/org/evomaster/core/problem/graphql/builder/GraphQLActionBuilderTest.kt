...
class GraphQLActionBuilderTest {
    ...
    fun contentfulSchemaTest() {
        ...
        assertTrue(((categoryCollection.parameters[4].gene.getWrappedGene(ObjectGene::class.java))?.fields?.get(6)?.getWrappedGene(StringGene::class.java) !=null))
        /**/
    ...
    fun anigListSchemaTest() {
        ...
        if (tupleScores != null) {
            assertEquals(3, tupleScores.elements.size)
        }
        ...
        if (tupleLengths != null) {
            assertEquals(3, tupleLengths.elements.size)
        }
        /**/
