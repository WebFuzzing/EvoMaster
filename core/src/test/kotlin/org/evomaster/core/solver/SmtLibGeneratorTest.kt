...
class SmtLibGeneratorTest {
    ...
    companion object {
        ...
        fun setup() {
            ...
            generator = SmtLibGenerator(SMTLibZ3DbConstraintSolver.buildSmtTables(schemaDto), schemaDto.databaseType, 2)
        }
    ...
    fun selectFromTableWithBitColumn() {
        ...
        try {
            ...
            val bitGenerator = SmtLibGenerator(SMTLibZ3DbConstraintSolver.buildSmtTables(schemaDto), schemaDto.databaseType, 2)
    ...
    fun selectFromTableWithTimestampColumn() {
        ...
        try {
            ...
            val schemaDto = DbInfoExtractor.extract(conn)
            val timestampGenerator = SmtLibGenerator(SMTLibZ3DbConstraintSolver.buildSmtTables(schemaDto), schemaDto.databaseType, 2)
