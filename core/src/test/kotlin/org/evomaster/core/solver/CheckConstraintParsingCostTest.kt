 ...
 * linear, and a schema thirty times larger completes in milliseconds — so the cost had to come from
 ...
 * The work was both expensive and futile — the caller caught the exception and produced no
