 ...
 */
class SqlJsonGeneImpactTest : GeneImpactTest() {
    ...
    fun testfields(){
        val gene = getGene()
        var impact = (initImpact(gene) as SqlJsonGeneImpact)

        val pairf1 = template(gene, impact, listOf(ImpactOptions.IMPACT_IMPROVEMENT), 1)

        var updateImpact = (pairf1.second as SqlJsonGeneImpact)
        ...
        updateImpact = (pairf2.second as SqlJsonGeneImpact)
