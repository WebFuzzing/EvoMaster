 ...
 */
class UnsupportedVarcharCompositeTypeTest : ExtractTestBasePostgres() {

    override fun getSchemaLocation() = "/sql_schema/postgres_unsupported_composite_type_varchar.sql"
