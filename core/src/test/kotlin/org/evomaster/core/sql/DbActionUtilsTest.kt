...
class DbActionUtilsTest {
    ...
    fun testMultiColumnPrimaryKey() {
        ...
        assertTrue(SqlActionUtils.isValidColumnConstraints(listOf(action0)))
        ...
        assertFalse(SqlActionUtils.isValidColumnConstraints(listOf(action0, action1)))
        ...
        //should be fine
        assertTrue(SqlActionUtils.isValidColumnConstraints(listOf(action0, action2)))
    ...
    fun testNotRepeatedStringValues() {
        ...
        assertTrue(SqlActionUtils.isValidColumnConstraints(actions))
    ...
    fun testRepeatedStringValues() {
        ...
        assertTrue(SqlActionUtils.isValidForeignKeys(actions))
        assertFalse(SqlActionUtils.isValidColumnConstraints(actions))
    ...
    fun testForeignKeyColumn() {
        ...
        val foreignKey = ForeignKey(sourceColumns = listOf(fkColumn), targetTableId = table0.id, targetColumns = listOf(idColumn))
        ...
        val insertId1 = 1002L
        val fkGene = SqlForeignKeyGene("Id", insertId1, TableId("Table0"), "Id", false, insertId0)
    ...
    fun testDuplicatedForeignKeyToAutoIncrement() {
        ...
        val insertId2 = 1002L
        val fkGene0 = SqlForeignKeyGene("Id", insertId2, TableId("Table0"), "Id", false, insertId0)
        ...
        val insertId3 = 1003L
        val fkGene1 = SqlForeignKeyGene("Id", insertId3, TableId("Table0"), "Id", false, insertId0)
