...
class SqlXMLColumnTest : ExtractTestBasePostgres() {
    ...
    fun testIntegerElementInsertion() {
        ...
        val newGene = SqlXMLGene("xmldata", ObjectGene("anElement", listOf(IntegerGene("#text", value = 0))))
    ...
    fun testBooleanElementInsertion() {
        ...
        val newGene = SqlXMLGene("xmldata", ObjectGene("anElement", listOf(BooleanGene("#text", value = false))))
        val newInsertAction = SqlAction(table = action.table, selectedColumns = action.selectedColumns, insertionId = action.insertionId, computedGenes = listOf(newGene))
    ...
    fun testStringElementInsertion() {
        ...
        val newGene = SqlXMLGene("xmldata", ObjectGene("anElement", listOf(StringGene("#text", value = "Hello World"))))
        val newInsertAction = SqlAction(table = action.table, selectedColumns = action.selectedColumns, insertionId = action.insertionId, computedGenes = listOf(newGene))
    ...
    fun testEscapeString() {
        ...
        val newGene = SqlXMLGene("xmldata", ObjectGene("anElement", listOf(StringGene("#text", value = "<xml>This should be escaped</xml>"))))
        val newInsertAction = SqlAction(table = action.table, selectedColumns = action.selectedColumns, insertionId = action.insertionId, computedGenes = listOf(newGene))
