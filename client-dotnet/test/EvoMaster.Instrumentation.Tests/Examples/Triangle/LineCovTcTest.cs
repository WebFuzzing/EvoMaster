...
namespace EvoMaster.Instrumentation.Tests.Examples.Triangle {
    public class LineCovTcTest {
        ...
        public void TestSpecificLineCoverage(int a, int b, int c, string returnLine) {
            ...
            Assert.Contains("Line_at_TriangleClassificationImpl_00005", ObjectiveRecorder.AllTargets);
        ...
        [InlineData(-1, 0, 0, "Line_at_TriangleClassificationImpl_00026")]
        [InlineData(6, 6, 6, "Line_at_TriangleClassificationImpl_00007")]
        [InlineData(10, 6, 3, "Line_at_TriangleClassificationImpl_00011")]
        [InlineData(7, 6, 7, "Line_at_TriangleClassificationImpl_00019")]
        [InlineData(7, 6, 5, "Line_at_TriangleClassificationImpl_00023")]
