...
/*
    FIXME remove once resolved https://github.com/junit-team/junit5/issues/1947
 */
 ...
 * @since 1.0
 */
public class CustomMutableTestExecutionSummary implements TestExecutionSummary {
    ...
    public CustomMutableTestExecutionSummary(TestPlan testPlan) {
