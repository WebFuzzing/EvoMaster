...
public class H2DataTypesAppController extends SpringController {
    ...
    public static void main(String[] args) {
        H2DataTypesAppController controller = new H2DataTypesAppController();
    ...
    protected H2DataTypesAppController(Class<?> applicationClass) {
