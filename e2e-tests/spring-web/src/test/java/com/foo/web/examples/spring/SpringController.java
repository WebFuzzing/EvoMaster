package com.foo.web.examples.spring;
...
public abstract class SpringController extends EmbeddedSutController {
    ...
    protected SpringController(Class<?> applicationClass, String homePath) {
    ...
    public ProblemInfo getProblemInfo() {
        return new WebProblem("http://localhost:" + getSutPort()+homePath);
    }
