...
public class DeterminismTest extends AHypermuationTestBase {
    ...
    public void testDeterminismOfLog(){
        ...
        isDeterminismConsumer( new ArrayList<>(), (args) -> RestActionBuilderV3.INSTANCE.getModelsFromSwagger(schema, new LinkedHashMap<>()));
    }
    ...
    public void testNotDeterminismMIO() {
        ...
        isDeterminismConsumer(args, (x)-> initAndRun(args), 2, false);
    }
