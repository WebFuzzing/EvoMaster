...
class SchemaValidationDisableEMTest : SpringTestBase(){
    ...
    fun testRunEM_On_Invalid() {
        ...
        runTestHandlingFlakyAndCompilation(
                "SchemaValidationOnInvalidDisableEM",
                10
            ...
            assertFalse(DefinedFaultCategory.SCHEMA_INVALID_RESPONSE in faults)
        }
    }
