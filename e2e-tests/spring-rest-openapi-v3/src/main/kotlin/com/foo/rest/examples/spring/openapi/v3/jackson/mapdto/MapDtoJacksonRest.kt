...
@RestController
@RequestMapping(path = ["/api/jackson/mapdto"])
class MapDtoJacksonRest {
    ...
    fun post(@RequestBody json: String): ResponseEntity<String> {
        ...
        val collection = mapper.readValue(json, object:TypeReference<Map<String,MapDto>>(){})
        val dto : MapDto = collection["bar"] as MapDto
        val x : Int = dto.x!!
