...
$WB /e2e-tests/dotnet-rest/test/RestApis.Tests.ForAssertions  EmbeddedEvoMasterController.cs 42 hello 1000 2000 3000 66 bar xvalue yvalue true false simple-string simple-text 123 456 777 888
if [ $? -ne 0 ] ; then
