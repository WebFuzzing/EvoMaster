...
public abstract class PrimitiveOrWrapperParam<V> extends NamedTypedValue<PrimitiveOrWrapperType, V> implements NumericConstraintBase<BigDecimal> {
    ...
    public List<String> newInstanceWithJavaOrKotlin(boolean isDeclaration, boolean doesIncludeName, String variableName, int indent, boolean isJava) {
        ...
        if (accessibleSchema != null && accessibleSchema.setterMethodName != null)
            ...
            code = CodeJavaOrKotlinGenerator.oneLineInstance(isDeclaration, doesIncludeName, getType().getSimpleTypeName(), variableName, getValueAsJavaString(isJava), isJava);
        }
