...
public class OpenSearchQueryHelper {
     ...
     */
    public static String extractQueryKind(Object query) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
     ...
     */
    public static String extractFieldName(Object query, String structure) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
     ...
     */
    public static Object extractFieldValue(Object query, String structure) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        Object term = query.getClass().getMethod(structure).invoke(query);
     ...
     */
    public static Object extractTypedFieldValue(Object value) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
