...
CREATE TABLE "tblBooksAndVideos" ("BookID" INTEGER, "Book" INTEGER, "Video" INTEGER, "Kit" INTEGER, "Title" TEXT, "ISBN" TEXT, "Cover" TEXT, "Language" TEXT, "CD" INTEGER, "Cost" REAL, "CurrencyType" TEXT, "PublicationYear" TEXT, "Length" TEXT, "PublisherCode" TEXT, "Copyright-free" INTEGER, "Modified" DATETIME);
...
CREATE TABLE "tblSources" ("SourceID" TEXT, "SourceName" TEXT, "Retail" INTEGER, "Wholesale" INTEGER, "Contact" TEXT, "StreetAddress" TEXT, "City" TEXT, "StateProvince" TEXT, "PostalCode" TEXT, "Country" TEXT, "GeneralPhone" TEXT, "SalesPhone" TEXT, "FaxPhone" TEXT, "TechPhone" TEXT, "BBSPhone" TEXT, "CustServPhone" TEXT, "CISName" TEXT, "Amex" INTEGER, "MC" INTEGER, "Visa" INTEGER, "Discover" INTEGER, "Diners" INTEGER, "None" INTEGER, "TechSupport" INTEGER, "TechHours" TEXT, "Catalog" INTEGER, "CatCost" REAL, "CurrencyType" TEXT, "Refundable" INTEGER, "Showroom" INTEGER, "Notes" TEXT, "CISID" TEXT, "EMail" TEXT, "WebSite" TEXT, "Modified" DATETIME);
...
CREATE TABLE "tlkpReports" ("ObjectName" TEXT, "DisplayName" TEXT, "RecordSource" TEXT, "Width" REAL);
