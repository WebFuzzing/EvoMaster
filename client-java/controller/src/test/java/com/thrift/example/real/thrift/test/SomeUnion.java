        ...
        case MAP_THING:
          if (field.type == MAP_THING_FIELD_DESC.type) {
            java.util.Map<Numberz,java.lang.Long> map_thing;
            {
              ...
              {
                _key89 = com.thrift.example.real.thrift.test.Numberz.findByValue(iprot.readI32());
      ...
      switch (setField) {
        case MAP_THING:
          java.util.Map<Numberz,java.lang.Long> map_thing;
          {
            ...
            {
              _key94 = com.thrift.example.real.thrift.test.Numberz.findByValue(iprot.readI32());
