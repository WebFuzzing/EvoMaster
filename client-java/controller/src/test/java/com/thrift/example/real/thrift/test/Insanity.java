            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                {
                  _key1 = com.thrift.example.real.thrift.test.Numberz.findByValue(iprot.readI32());
                  _val2 = iprot.readI64();
                  if (_key1 != null)
                  {
      ...
      if (incoming.get(0)) {
        {
          ...
          {
            _key12 = com.thrift.example.real.thrift.test.Numberz.findByValue(iprot.readI32());
