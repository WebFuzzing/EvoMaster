...
public class DbCleanerMySQLTest extends DbCleanerTestBase{
    ...
    @Override
    protected void clearDatabase(List<String> tables, boolean areTableToSkip) {
        DbCleaner.clearDatabase(connection, DB_NAME, tables, areTableToSkip, DatabaseType.MYSQL);
    }
