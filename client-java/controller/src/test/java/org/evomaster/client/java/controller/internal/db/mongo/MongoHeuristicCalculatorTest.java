...
class MongoHeuristicCalculatorTest {
    ...
    public void testNotEquals() {
        ...
        Double distanceMatch1 = new MongoHeuristicsCalculator().computeExpression(bsonTrue1, doc);
        Double distanceMatch2 = new MongoHeuristicsCalculator().computeExpression(bsonTrue2, doc);
        Double distanceNotMatch = new MongoHeuristicsCalculator().computeExpression(bsonFalse, doc);
