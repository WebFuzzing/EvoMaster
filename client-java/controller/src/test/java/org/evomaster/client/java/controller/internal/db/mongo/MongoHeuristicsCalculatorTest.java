...
class MongoHeuristicsCalculatorTest {
    ...
    public void testEquals() {
        ...
        Double distanceMatch = new MongoHeuristicsCalculator().computeDistance(convertToDocument(bsonTrue), doc);
        Double distanceNotMatch = new MongoHeuristicsCalculator().computeDistance(convertToDocument(bsonFalse), doc);
    ...
    public void testNotEquals() {
        ...
        Double distanceMatch1 = new MongoHeuristicsCalculator().computeDistance(convertToDocument(bsonTrue1), doc);
        Double distanceMatch2 = new MongoHeuristicsCalculator().computeDistance(convertToDocument(bsonTrue2), doc);
        Double distanceNotMatch = new MongoHeuristicsCalculator().computeDistance(convertToDocument(bsonFalse), doc);
