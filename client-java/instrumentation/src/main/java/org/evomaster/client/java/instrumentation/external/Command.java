...
public enum Command implements Serializable {
    ...
    NEW_SEARCH, NEW_TEST, TARGETS_INFO, ACK, ACTION_INDEX, ADDITIONAL_INFO, UNITS_INFO, KILL_SWITCH, EXECUTING_INIT_SQL, EXECUTING_ACTION, BOOT_TIME_INFO, EXTRACT_JVM_DTO
}
