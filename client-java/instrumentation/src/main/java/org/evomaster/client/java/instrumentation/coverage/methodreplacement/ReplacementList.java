    ...
    public static List<MethodReplacementClass> getList() {
        ...
        if(listCache == null) {
            listCache = Arrays.asList(
                    ...
                    new DynamoDbEnhancedClientClassReplacement.SyncTable(),
                    new DynamoDbEnhancedClientClassReplacement.AsyncTable(),
                    new DynamoDbEnhancedClientClassReplacement.SyncClient(),
                    new DynamoDbEnhancedClientClassReplacement.AsyncClient(),
