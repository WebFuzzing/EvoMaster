...
public class RegexDistanceUtils {
    ...
    private static Automaton getRegexAutomaton(String regex) {
    ...
    private static String getRegexInstance(String regex) {
        if (!regexAutomatonCache.containsKey(regex)) {
            cacheRegex(regex);
        }
    ...
    private static String getNonMatchingRegexInstance(String regex) {
        if (!regexAutomatonCache.containsKey(regex)) {
            cacheRegex(regex);
        }
        Automaton automaton = regexAutomatonCache.get(regex);
