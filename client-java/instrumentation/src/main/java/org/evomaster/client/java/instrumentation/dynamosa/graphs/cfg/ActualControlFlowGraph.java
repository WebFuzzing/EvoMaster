...
public class ActualControlFlowGraph extends ControlFlowGraph<BasicBlock> {
    ...
    public void checkSanity() {
        ...
        SimpleLogger.debug("checking sanity of CFG for " + methodName);
        ...
        SimpleLogger.debug(".. all initInstructions contained");

        //		checkNodeSanity();

        checkInstructionsContainedOnceConstraint();

        SimpleLogger.debug(".. CFG sanity ensured");
    }
    ...
    void checkNodeSanity() {
        ...
        SimpleLogger.debug("..all node constraints ensured");
    }
