...
public class OkHttpClientBuilderClassReplacement extends ThirdPartyMethodReplacementClass {
    ...
    public static void Builder()  {
        ...
        Constructor original = getOriginalConstructor(singleton, "okhttpclient_builder_constructor");
    ...
    public static OkHttpClient.Builder hostnameVerifier(Object caller, HostnameVerifier hostnameVerifier)  {
        ...
        Method original = getOriginal(singleton, "okhttpclient_builder_hostnameVerifier", caller);
    ...
    public static OkHttpClient.Builder sslSocketFactory(Object caller, SSLSocketFactory sslSocketFactory, X509TrustManager trustManager)  {
        ...
        Method original = getOriginal(singleton, "okhttpclient_builder_sslSocketFactory", caller);
    ...
    public static OkHttpClient.Builder sslSocketFactory(Object caller, SSLSocketFactory sslSocketFactory)  {
        ...
        Method original = getOriginal(singleton, "okhttpclient_builder_sslSocketFactory_onearg", caller);
