...
class JavaDeclarationEntity (specification: PropertySpecification): JavaDeclaration(specification) {
    override fun getTags(): List<String> {
        ...
        when(this.specification.multiplicity){
            ...
            RelationMultiplicity.ONE_TO_ONE -> tags.add(JavaxAnnotation.ONE_TO_ONE.getText())
            RelationMultiplicity.ONE_TO_MANY -> tags.add(JavaxAnnotation.ONE_TO_MANY.getText())
            else->{}
        }
        return tags.toList()
    }
