 ...
 */
class JavaRestPostValueMethod(val specification: ServiceClazz) : JavaMethod(), SpringRestAPI {
    ...
    override fun getName(): String  = "post${FormatUtil.upperFirst(specification.name)}ByValues"
