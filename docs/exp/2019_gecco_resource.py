...
############################################################################
### resource-based MIO experiment setting
############################################################################
...
ALL_SMART_SAMPLE_PROB = ParameterSetting("probOfSmartSampling", [0.25, 0.5, 0.75, 1.0])

MIO_BASE1= Solution("MIO_BASE1", [NONE_RES_SMART_SAMPLE, ZERO_SMART_SAMPLE_PROB])
MIO_BASE2= Solution("MIO_BASE2", [NONE_RES_SMART_SAMPLE, NONE_RES_SMART_SAMPLE])
MIO_REST_RESOURCE= Solution("MIO_REST_RESOURCE", [ALL_RES_SMART_SAMPLE, ALL_SMART_SAMPLE_PROB])


MIO_RES = Experiment("MIO_RES",[MIO_BASE1,MIO_BASE2,MIO_REST_RESOURCE])
