...
def getConfigs():
    ...
    #--externalServiceIPSelectionStrategy=USER --instrumentMR_NET=true --probOfHarvestingResponsesFromActualExternalServices=0.5 --probOfMutatingResponsesBasedOnActualResponse=0.1 --probOfPrioritizingSuccessfulHarvestedActualResponses=0.9
