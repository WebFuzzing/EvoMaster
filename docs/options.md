...
|`externalServiceIP`| __String__. User provided external service IP. *Constraints*: `regex ^127\.((0\.){2}([3-9]\|[1-9]\d\|[12]\d\d)\|0\.([1-9]\|[1-9]\d\|[12]\d\d)\.([1-9]?\d\|[12]\d\d)\|([1-9]\|[1-9]\d\|[12]\d\d)(\.([1-9]?\d\|[12]\d\d)){2})$`. *Default value*: `127.0.0.3`.|
