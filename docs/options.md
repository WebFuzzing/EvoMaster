...
|`externalServiceIP`| __String__. User provided external service IP. *Constraints*: `regex ^127\.((25[0-5]\|2[0-4][0-9]\|[01]?[0-9][0-9]?)\.){2}(25[0-5]\|2[0-4][0-9]\|[3-9]\|[0-2][0-5][0-5]?)$`. *Default value*: `127.0.0.3`.|
