...
|`maxSizeOfInitHarvestedDbRecordsPerTable`| __Int__. Specify a maximum number of harvested records per table as seeds at the beginning of the search. *Constraints*: `min=0.0`. *Default value*: `0`.|
