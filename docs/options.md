...
|Options|Description|
|---|---|
|`algorithm`| __Enum__. The algorithm used to generate test cases. *Valid values*: `MIO, RANDOM, WTS, MOSA`, *Experimental Values*: `This is under work`  *Default value*: `MIO`.|
...
|`feedbackDirectedSampling`| __Enum__. Specify whether when we sample from archive we do look at the most promising targets for which we have had a recent improvement. *Valid values*: `NONE, LAST, FOCUSED_QUICKEST`, *Experimental Values*: `This is under work`  *Default value*: `LAST`.|
...
|`geneMutationStrategy`| __Enum__. Strategy used to define the mutation probability. *Valid values*: `ONE_OVER_N, ONE_OVER_N_BIASED_SQL`, *Experimental Values*: `This is under work`  *Default value*: `ONE_OVER_N_BIASED_SQL`.|
...
|`secondaryObjectiveStrategy`| __Enum__. Strategy used to handle the extra heuristics in the secondary objectives. *Valid values*: `AVG_DISTANCE, AVG_DISTANCE_SAME_N_ACTIONS, BEST_MIN`, *Experimental Values*: `This is under work`  *Default value*: `AVG_DISTANCE_SAME_N_ACTIONS`.|
...
|`stoppingCriterion`| __Enum__. Stopping criterion for the search. *Valid values*: `TIME, FITNESS_EVALUATIONS`, *Experimental Values*: `This is under work`  *Default value*: `TIME`.|
...
|`adaptiveGeneSelectionMethod`| __Enum__. Specify whether to enable archive-based selection for selecting genes to mutate. *Valid values*: `NONE, AWAY_NOIMPACT, APPROACH_IMPACT, APPROACH_LATEST_IMPACT, APPROACH_LATEST_IMPROVEMENT, BALANCE_IMPACT_NOIMPACT, ALL_FIXED_RAND`, *Experimental Values*: `This is under work`  *Default value*: `NONE`.|
...
|`archiveGeneMutation`| __Enum__. Whether to enable archive-based gene mutation. *Valid values*: `NONE, SPECIFIED, ADAPTIVE`, *Experimental Values*: `This is under work`  *Default value*: `NONE`.|
|`coveredTargetSortedBy`| __Enum__. Specify a format to organize the covered targets by the search. *Valid values*: `NAME, TEST`, *Experimental Values*: `This is under work`  *Default value*: `NAME`.|
...
|`mutationTargetsSelectionStrategy`| __Enum__. Specify a strategy to select targets for evaluating mutation. *Valid values*: `FIRST_NOT_COVERED_TARGET, EXPANDED_UPDATED_NOT_COVERED_TARGET, UPDATED_NOT_COVERED_TARGET`, *Experimental Values*: `This is under work`  *Default value*: `FIRST_NOT_COVERED_TARGET`.|
...
|`testSuiteSplitType`| __Enum__. Instead of generating a single test file, it could be split in several files, according to different strategies. *Valid values*: `NONE, CLUSTER, SUMMARY_ONLY, CODE`, *Experimental Values*: `This is under work`  *Default value*: `NONE`.|
