...
|`languageModelName`| __String__. Large-language model name string from Ollama. *Default value*: `null`.|
|`languageModelServerURL`| __String__. Large-language model URL. *Default value*: `null`.|
