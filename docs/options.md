...
|`namingStrategy`| __Enum__. Specify the naming strategy for test cases. If left on `DEFAULT`, Numbered strategy will be used naming tests for example as `test_1`, `test_2`. *Valid values*: `DEFAULT, NUMBERED`. *Default value*: `DEFAULT`.|
