...
|`overlayFileSuffixes`| __String__. Comma ',' separated list of file name suffixes. When scanning a folder for OAI Overlay files, any file with name matching any one of these suffixes will be loaded and applied. *Default value*: `.json,.yaml,.yml`.|
