...
class MultiDbMongoRedisPostgresControllerTest {

    private lateinit var controller: MultiDbMongoRedisPostgresSutController
    private lateinit var baseUrl: String

    @BeforeEach
    fun setUp() {
        controller = MultiDbMongoRedisPostgresSutController()
    ...
    fun testCanStartSutAndAccessEndpoints() {
        ...
        RestAssured.given().get("$baseUrl/api/get/42").then().statusCode(400)
        ...
        RestAssured.given().get("$baseUrl/api/get/42").then().statusCode(200)
    }
}
