package org.evomaster.e2etests.spring.rest.neo4j.session.findnode;

import com.foo.spring.rest.neo4j.session.findnode.Neo4jSessionFindNodeController;
...
public class Neo4jSessionFindNodeEMTest extends RestTestBase {
    ...
    public static void initClass() throws Exception {
        ...
        RestTestBase.initClass(new Neo4jSessionFindNodeController(), config);
    }
    ...
    public void testFindNodeEM() throws Throwable {
        ...
        runTestHandlingFlakyAndCompilation(
                "Neo4jSessionFindNodeEM",
                "org.foo.spring.rest.neo4j.Neo4jSessionFindNodeEM",
                1000,
                true,
                (args) -> {
