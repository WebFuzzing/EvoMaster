...
$RUN /client-js/integration-tests/build/src/for-assertions-api   em-main.js   app-driver.js  50  42 hello 1000 2000 3000 66 bar xvalue yvalue true false simple-string simple-text 123 456 777 888 FUCK
if [ $? -eq 0 ] ; then
